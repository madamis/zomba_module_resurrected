...
class HelpPane(QtWidgets.QWidget, HELP_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(HelpPane, self).__init__(parent)
        self.setupUi(self)

REPORT_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'report.ui'))


class ReportPane(QtWidgets.QWidget, REPORT_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
